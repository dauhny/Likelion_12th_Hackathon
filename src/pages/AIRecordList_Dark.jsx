...
import * as A from "../styles/styledAIRecordList_Dark";
import { useNavigate, useLocation } from "react-router-dom";
import { useState, useEffect } from "react";

export function AIRecordList_Dark() {
  ...
  const goAIResult_Dark = () => {
    navigate(`/airesult_dark`);
  };
    ...
    <>
      <A.Container>
        ...
        <A.Item>
          ...
          <A.Analysis onClick={goAIResult_Dark}>
            <div id="choice">
